...
private:
    ...
    void updateParameters(MatrixXd &theta1Grad,MatrixXd &theta2Grad,MatrixXd &b1Grad,MatrixXd &b2Grad,MatrixXd &softmaxTheta,double alpha);
...
public:
    ...
    void preTrain(MatrixXd &data,MatrixXi &labels,
        ...
        int maxIter[],double noiseRatio[] = NULL,
        double beta[] = NULL);
